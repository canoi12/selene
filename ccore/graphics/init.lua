...
local current = {
  ...
  canvas = {},
  shader = {},
  projection = selene.linmath.Mat4.create(),
  modelview = selene.linmath.Mat4.create(),
...
function graphics.init(config)
  ...
  default.shader = Effect.create()

  default.vao = gl.VertexArray.create()
