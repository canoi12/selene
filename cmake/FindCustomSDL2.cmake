...
if (DEFINED MSVC)
    set (SDL_PRECOMP_DIR "${CACHE_DIR}/SDL2-${SDL_VERSION}/MSVC" CACHE STRING "Set SDL2 dir")
elseif (DEFINED MINGW)
    set (SDL_PRECOMP_DIR "${CACHE_DIR}/SDL2-${SDL_VERSION}/MINGW" CACHE STRING "Set SDL2 dir")
else ()
...
if (DEFINED SDL2_DIR)
    message("Precompiled SDL2: ${SDL2_DIR}")
    set(ENV{SDL2_DIR} "${SDL2_DIR}")
    find_package(SDL2 REQUIRED)
    # message("${SDL2_LIBRARY} ${SDL2_DLL} ${SDL2_LIBRARIES}")
